    ...
    try:
        ...
        for result in results[:5]:
            ...
            if title_elem and title_elem.find("a"):
                ...
                link = "https://www.rbi.org.in/" + title_elem.find("a")["href"] # Added base URL
            else:
                title = "No title"
                link = "#"
...
response_task = Task(
    description="Provide compliance advice for the query: {query} using retrieved documents.  The documents will be in the format of a Pydantic class Documents, containing a list of Document objects. Each Document object has a 'content' and a 'source' field.",
